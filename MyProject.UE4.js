...
var Module = {
	...
	UE4_indexedDBName: 'UE4_assetDatabase_MyProject', // this should be an ascii ID string without special characters that is unique to the project that is being packaged
	UE4_indexedDBVersion: 202203291311, // Bump this number to invalidate existing IDB storages in browsers.
};
...
Module.arguments = ['../../../MyProject/MyProject.uproject','-stdout',];
